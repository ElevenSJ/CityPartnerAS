...
public class QueryOrderByDateActivity extends BaseActivity implements OnRefreshListener2<ListView> {
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			switch (msg.what) {
			case MessageContants.MSG_GET_ORDER_LIST_BY_DATE: {
	...
	private void getData() {
		...
		String saleId = mSharedPreferences.getString(Constant.ID, "");
		 NetProxyManager.getInstance().toGetOrderListByDate(mHandler, tokenid, saleId, startTime, endTime,
				 mCurrentIndex, mRow);
//		NetProxyManager.getInstance().toGetOrderListByDate(mHandler, saleId, startTime, endTime);
	}
