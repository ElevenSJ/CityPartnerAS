...
//        }
     ...
     * 一次申请多个权限
     */
    public static void requestMultiPermissionsCommon(final Activity activity, final @NonNull String[] permissions , PermissionGrant grant) {
