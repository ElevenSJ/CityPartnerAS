...
public class QueryOrderAdapter extends BaseAdapter {
	...
	public QueryOrderAdapter(List<OrderBean> orderList, Activity context) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(activity).inflate(R.layout.query_order_item, null);
		...
		viewHolder.order_no.setText("No." + orderBean.getOrdercode());
		viewHolder.order_date.setText(DateUtil.stringToStr(orderBean.getOrdertime()));
		viewHolder.shop_name.setText(orderBean.getShopname());
