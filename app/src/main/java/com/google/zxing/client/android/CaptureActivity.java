...
import com.lyp.citypartner.AddOrderActivity;
...
//        bundle.putString(INTENT_EXTRA_KEY_QR_SCAN, resultString);
        LogUtils.d("lyp", "scan result = " + resultString);
        // 不能使用Intent传递大于40kb的bitmap，可以使用一个单例对象存储这个bitmap
//        bundle.putParcelable("bitmap", barcode);
//        Logger.d("saomiao",resultString);
//        resultIntent.putExtras(bundle);
//        this.setResult(RESULT_CODE_QR_SCAN, resultIntent);
        resultIntent.setClass(this, AddOrderActivity.class);
        resultIntent.putExtra("cId", resultString);
